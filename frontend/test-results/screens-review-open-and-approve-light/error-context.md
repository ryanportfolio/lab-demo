...
- Name: screens.spec.ts >> review open and approve, light
- Location: e2e\screens.spec.ts:47:1
...
- region "Prediction Lab window":
  - text: Prediction Lab›Models›Bodily Injury Frequency›Review
  - button "← Back to the run"
  - paragraph: No review is open for this run.
  - complementary:
    ...
    - text: Lift against factor budget used. Dots land as fits finish. Blue holds the current frontier.
