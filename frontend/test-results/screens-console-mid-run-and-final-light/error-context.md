...
- Name: screens.spec.ts >> console mid-run and final, light
- Location: e2e\screens.spec.ts:18:1
...
- region "Prediction Lab window":
  ...
  - text: Loading the run runs on its own branch 0 of 7 experiments 0 candidates 0 scrapped elapsed 0.0s
  - button "Replay run"
  - complementary:
