...
| Status | Skills |
|---|---|
| Native | `brainstorming`, `caveman`, `designing-actuarial-chart-workspaces`, `enhance-prompt`, `forge-repo-ui-skill`, `handoff-audit`, `humanizer`, `prediction-lab-actuarial-ux`, `purposeful-writing`, `recall`, `researching-actuarial-ux`, `writing-plans` |
